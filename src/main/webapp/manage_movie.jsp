...
<ul>
  ...
  <li ><a class="active" href="manage_movie.jsp">Manage Movies</a></li>
...
%>
	...
	<td><a href="update_movie.jsp?movie_name=<%=rs.getString(1)%>">Update</a>|<a href="delete_movie.jsp?movie_name=<%=rs.getString(1)%>">Delete</a></td>
